...
const Footer = () => {
  return (
    <footer
      ...
      className="bg-gray-100 relative rounded-t-[4rem] overflow-hidden"
    >
      {/* <div className="absolute inset-0 bg-[url('assets/images/hero.jpg')] bg-cover bg-center" /> */}
      <div className="relative bg-white/50 backdrop-blur-lg">
        <div className="mx-auto relative max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-sm leading-5 text-black/70 md:order-1 md:mt-0">
              &copy; {new Date().getFullYear()} Oxygen, Inc. All rights
              reserved.
            </p>
          </div>
        </div>
